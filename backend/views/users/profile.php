    ...
    <form class="row" action="" method="post" enctype="multipart/form-data">
        <div class="col-sm-3"><!--left col-->
            ...
            <div class="text-center">
                <img src="assets/uploads/<?php echo $_SESSION['admin']['avatar'] ?>" class="avatar img-circle img-thumbnail" alt="avatar">
                    ...
                    <div class="form"  id="registrationForm">
                        <div class="form-group">
                            ...
                            <div class="col-xs-6">
                                ...
                                <input type="text" class="form-control" name="first_name"  value="<?php echo $_SESSION['admin']['first_name'] ?>"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-6">
                                ...
                                <input type="text" class="form-control" value="<?php echo $_SESSION['admin']['last_name'] ?>"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-6">
                                ...
                                <input type="text" class="form-control" value="<?php echo $_SESSION['admin']['phone'] ?>"
                        ...
                        <div class="form-group">
                            <div class="col-xs-6">
                                ...
                                <input type="text" class="form-control" value="<?php echo $_SESSION['admin']['address'] ?>"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-6">
                                ...
                                <input type="text" class="form-control" value="<?php echo $_SESSION['admin']['facebook'] ?>"
